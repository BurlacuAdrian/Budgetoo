...
const ToggleButton = ({comparandBase, leftComparand, rightComparand, leftText, rightText, leftClickHandler, rightClickHandler}) => {

  return (
    <div className="flex rounded-full bg-gray-300 p-0 mt-8">
      <button
